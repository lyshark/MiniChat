...
class AgentSFTDataset(Dataset):
    def __init__(self, data_list, tokenizer, max_seq_len: int):
        ...
        self.im_start_id = self._get_special_id("<|im_start|>")
        self.im_end_id = self._get_special_id("<|im_end|>")
        self.tc_start_id = self._get_special_id("<|tool_call_start|>")
        self.tc_end_id = self._get_special_id("<|tool_call_end|>")
...
def train_agent_sft(
    ...
    train_dataset = AgentSFTDataset(split["train"], tokenizer, max_seq_len)
    eval_dataset = AgentSFTDataset(split["test"], tokenizer, max_seq_len)
